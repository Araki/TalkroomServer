...
class InquiriesControllerTest < ActionController::TestCase
  ...
  test "should create inquiry" do
    assert_difference('Inquiry.count') do
      post :create, :inquiry => { :address => @inquiry.address, :list_id => @inquiry.list_id, :platform => @inquiry.platform }
    end
  ...
  test "should update inquiry" do
    put :update, :id => @inquiry, :inquiry => { :address => @inquiry.address, :list_id => @inquiry.list_id, :platform => @inquiry.platform }
    assert_redirected_to inquiry_path(assigns(:inquiry))
  end
